    ...
    <div id="leftSide" class="authorBio clearfix pad column8 down downV">
        ...
        ?>
            ...
            <div id="bioMiembro">
                ...
                <?php if(get_field('empresa',"user_$curauth->ID")){?><p class="subTitulo"><strong>Empresa:</strong> <?php the_field('empresa',"user_$curauth->ID"); ?></p><?php } ?>
                <?php if(get_field('cargo',"user_$curauth->ID")){?><p class="subTitulo"><strong>Cargo:</strong> <?php the_field('cargo',"user_$curauth->ID"); ?></p><?php } ?>
                <?php if(get_field('telefono',"user_$curauth->ID")){?><p class="subTitulo"><strong>Teléfono:</strong> <?php the_field('telefono',"user_$curauth->ID"); ?></p> <?php } ?>               
                <?php if(get_field('mail',"user_$curauth->ID")){?><p class="subTitulo"><strong>Mail: </strong> <a href="mailto:<?php the_field('mail',"user_$curauth->ID");?>"><?php the_field('mail',"user_$curauth->ID"); ?></a></p> <?php } ?>
                <?php if(get_field('edad',"user_$curauth->ID")){?><p class="subTitulo"><strong>Edad: </strong><?php the_field('edad',"user_$curauth->ID"); ?></a></p><?php } ?>
                <?php if(get_field('estado_civil',"user_$curauth->ID")){?>
                ...
                <?php if(get_field('grupo_familiar',"user_$curauth->ID")){?>
