...
class WP_Locale {
	...
	function init() {
		...
		$this->weekday_initial[__('Miércoles')] = /* translators: one-letter abbreviation of the weekday */ __('W_Wednesday_initial');
		...
		$this->weekday_initial[__('Sábado')]  = /* translators: one-letter abbreviation of the weekday */ __('S_Saturday_initial');
		...
		// 'May' duplication.
		$this->month_abbrev[__('Enero')] = /* translators: three-letter abbreviation of the month */ __('Ene_January_abbreviation');
		...
		$this->month_abbrev[__('Abril')] = /* translators: three-letter abbreviation of the month */ __('Abr_April_abbreviation');
		...
		$this->month_abbrev[__('Agosto')] = /* translators: three-letter abbreviation of the month */ __('Ago_August_abbreviation');
		...
		$this->month_abbrev[__('Diciembre')] = /* translators: three-letter abbreviation of the month */ __('Dic_December_abbreviation');
